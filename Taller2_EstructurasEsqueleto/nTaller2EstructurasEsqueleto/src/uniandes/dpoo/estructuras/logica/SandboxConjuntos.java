...
public class SandboxConjuntos
{
    ...
    public List<String> getCadenasComoListaInvertida( )
    {
    		...
    		if(arbolCadenas.size()!=0) {
    			Iterator<String> palabra = arbolCadenas.descendingIterator();
    			while (palabra.hasNext()) {
    				lista.add(palabra.next());
    			}
    		}
        return lista;
    }
    ...
    {	
    		if(arbolCadenas.size()!=0) {return arbolCadenas.first();}
    		return null;
    }
    ...
    {
        if(arbolCadenas.size()!=0) {return arbolCadenas.last();}
        return null;
    }
    ...
    {
    		if(arbolCadenas.size()!= 0) {arbolCadenas.remove(arbolCadenas.first());}
    }
    ...
    {
    		TreeSet<String> arbolInvertido = new TreeSet<String>(Comparator.reverseOrder());
    		for(String palabra: arbolCadenas) {
    			arbolInvertido.add(palabra);
    		}
    ...
    public boolean compararElementos( String[] otroArreglo )
    {
        ...
        if(cont==otroArreglo.length) {return true;}
    		return false;
    }
